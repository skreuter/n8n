...
export async function bitrixApiRequest(
	...
	const credentials = await this.getCredentials('bitrixApi') as BitrixApiCredentials;
...
export async function getFields(
	...
	let { fields } = await bitrixApiRequest.call(this, 'GET', '/settings/fields', {}, qs) as LoadedFields;
...
export async function getPicklistOptions(
	...
	const qs = { module: getModuleName(resource) };
	const responseData = await bitrixApiRequest.call(this, 'GET', '/settings/layouts', {}, qs) as LoadedLayouts;
