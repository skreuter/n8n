...
export class Bitrix24 implements INodeType {
	description: INodeTypeDescription = {
		...
		version: 1,
		description: 'Consume Bitrix24 API',
		defaults: {
			name: 'Bitrix24',
		},
		inputs: ['main'],
	...
	methods = {
		loadOptions: {
			...
			async getAccounts(this: ILoadOptionsFunctions) {
				const accounts = await bitrixApiRequestAllItems.call(this, 'GET', '/accounts') as LoadedAccounts;
				return toLoadOptions(accounts, 'Account_Name');
			},

			async getContacts(this: ILoadOptionsFunctions) {
				const contacts = await bitrixApiRequestAllItems.call(this, 'GET', '/contacts') as LoadedContacts;
				return toLoadOptions(contacts, 'Full_Name');
			},

			async getDeals(this: ILoadOptionsFunctions) {
				const deals = await bitrixApiRequestAllItems.call(this, 'GET', '/deals') as LoadedDeals;
				return toLoadOptions(deals, 'Deal_Name');
			},

			async getProducts(this: ILoadOptionsFunctions) {
				const products = await bitrixApiRequestAllItems.call(this, 'GET', '/products') as LoadedProducts;
				return toLoadOptions(products, 'Product_Name');
			},

			async getVendors(this: ILoadOptionsFunctions) {
				const vendors = await bitrixApiRequestAllItems.call(this, 'GET', '/vendors') as LoadedVendors;
			...
			try {
				...
				if (resource === 'account') {
					...
					if (operation === 'create') {
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/accounts', body);
						...
						responseData = await bitrixApiRequest.call(this, 'DELETE', endpoint);
						responseData = responseData.data[0].details;
						...
						const endpoint = `/accounts/${accountId}`;
						responseData = await bitrixApiRequest.call(this, 'GET', endpoint);
						...
						const endpoint = `/accounts/${accountId}`;
						responseData = await bitrixApiRequest.call(this, 'PUT', endpoint, body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/accounts/upsert', body);
						responseData = responseData.data[0].details;
					...
					if (operation === 'create') {
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/contacts', body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/contacts/upsert', body);
						responseData = responseData.data[0].details;
					...
					if (operation === 'create') {
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/deals', body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'DELETE', `/deals/${dealId}`);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'GET', `/deals/${dealId}`);
						responseData = responseData.data;
						...
						responseData = await bitrixApiRequest.call(this, 'PUT', `/deals/${dealId}`, body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/deals/upsert', body);
						responseData = responseData.data[0].details;
					...
					if (operation === 'create') {
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/invoices', body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/invoices/upsert', body);
						responseData = responseData.data[0].details;
					...
					if (operation === 'create') {
						...
						const body: IDataObject = {
							fields: {
								TITLE: this.getNodeParameter('Company', i),
								NAME: this.getNodeParameter('lastName', i),
								STATUS_ID: 'NEW',
								OPENED: 'Y',
								ASSIGNED_BY_ID: 3, // assigned by
								COMMENTS: ':comments',
								COMPANY_TITLE: this.getNodeParameter('Company', i),
								SOURCE_ID: 'UC_LLO8FO',
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/crm.lead.add', body);
						...
						responseData = await bitrixApiRequest.call(this, 'DELETE', `/leads/${leadId}`);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'GET', `/crm.lead.get?id=${leadId}`);
						...
						responseData = await bitrixApiRequest.call(this, 'GET', '/settings/fields', {}, { module: 'leads' });
						...
						responseData = await bitrixApiRequest.call(this, 'PUT', `/leads/${leadId}`, body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/leads/upsert', body);
						responseData = responseData.data[0].details;
					...
					if (operation === 'create') {
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/products', body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/products/upsert', body);
						responseData = responseData.data[0].details;
					...
					if (operation === 'create') {
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/purchase_orders', body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/purchase_orders/upsert', body);
						responseData = responseData.data[0].details;
					...
					if (operation === 'create') {
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/quotes', body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'DELETE', `/quotes/${quoteId}`);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'GET', `/quotes/${quoteId}`);
						responseData = responseData.data;
						...
						responseData = await bitrixApiRequest.call(this, 'PUT', `/quotes/${quoteId}`, body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/quotes/upsert', body);
						responseData = responseData.data[0].details;
					...
					if (operation === 'create') {
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/sales_orders', body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/sales_orders/upsert', body);
						responseData = responseData.data[0].details;
					...
					if (operation === 'create') {
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/vendors', body);
						responseData = responseData.data[0].details;
						...
						responseData = await bitrixApiRequest.call(this, 'POST', '/vendors/upsert', body);
						responseData = responseData.data[0].details;
